...
The document is available in a temporary location as HTML (https://labs.gbif.org/documents/gbif-communications-strategy/index.en.html[EN], https://labs.gbif.org/documents/gbif-communications-strategy/index.pt.html[PT]) and PDF (https://labs.gbif.org/documents/gbif-communications-strategy/index.en.pdf[EN], https://labs.gbif.org/documents/gbif-communications-strategy/index.pt.pdf[PT]).
